...
const MapSection = () => {
  ...
  useEffect(() => {
    const observer = new IntersectionObserver(
      ([entry]) => { if (entry.isIntersecting) entry.target.classList.add('fade-in'); },
      { threshold: 0.1 }
    );
        ...
        <div className="map-wrapper">
          ...
          <div className="location-card-wrapper">
            <div className="glass-card location-card">
              ...
              <a href={mapUrl} target="_blank" rel="noopener noreferrer" className="btn-directions">
