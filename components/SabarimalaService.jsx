...
const SabarimalaService = () => {
  ...
  return (
    <section id="sabarimala-service" className="sab-section" ref={sectionRef}>
      ...
      <div className="container">
        <div className="sab-header">
          ...
          <p className="sab-subtitle">Comfortable and reliable taxi service for Sabarimala pilgrims.</p>
        </div>

        <div
          className="sab-banner-wrapper"
          onClick={handleWhatsApp}
          role="button"
          tabIndex={0}
          onKeyPress={e => e.key === 'Enter' && handleWhatsApp()}
          aria-label="Enquire about Sabarimala taxi on WhatsApp"
        >
          <div style={{ position: 'relative', width: '100%', height: '400px' }}>
            <Image
              src="/images/assets/sabarimala_temple.jpg"
        ...
        <div className="sab-content-card">
          ...
          <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap', marginTop: '20px' }}>
            ...
            >
              View 2026 Sabarimala Timings & Packages ➔
            </a>
          </div>
        </div>
      </div>
